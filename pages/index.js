        ...
        <section className="h-full max-w-5xl mx-auto pt-16 md:pt-8">
          <div className="flex flex-col items-center justify-center md:items-start">
            ...
            <div className="flex items-center mt-8 space-x-6 md:mt-4">
              <motion.a
                href="https://github.com/volkanbasaran1"
                target={"_blank"}
              ...
              <motion.a
                href="https://www.linkedin.com/in/volkanbasaran1/"
                target={"_blank"}
                rel="noopener noreferrer"
                className="flex items-center justify-center text-gray-800 transition-colors duration-300 dark:text-gray-100 dark:hover:text-pinkish-200 hover:text-pinkish-200"
                whileHover={{ scale: 1.1 }}
              ...
              <pre>
                <code className="language-js">
                  ...
                  <div className="flex items-center space-x-4">
                    <img
                      src="https://media.licdn.com/dms/image/C4D03AQE-Free7g00aQ/profile-displayphoto-shrink_800_800/0/1651232032982?e=1717027200&v=beta&t=WqgBNzBaxlWPzdhpId3YT10pKHVOb5C32fYt2AgOD_M"
                      alt="Me"
